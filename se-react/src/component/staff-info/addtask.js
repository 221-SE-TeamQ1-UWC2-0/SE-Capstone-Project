...
import { FaUserCircle, FaPlus, FaFontAwesomeFlag } from 'react-icons/fa';
      ...
      <div className='in4-sidebar'>
        <div className='task-opt'>
          ...
          <SideBarItem
            ...
            href='/janitor-info'
          />
          <SideBarItem Item={RiTruckLine} page='Vehicle' href='/' />
          <SideBarItem Item={MdOutlineAddLocation} page='MCP' href='/' />
        </div>
        <hr></hr>
        <div className='in4-overview'>
          <div style={{ display: 'flex', margin: '0em 1.5em' }}>
            ...
            <MdAddCircleOutline
              style={{ marginTop: '.9em', fontSize: '25px', color: '#454545' }}
            />
          </div>
          ...
          <div className='in4-holder'>
            <div className='in4-holder-left'>
              <form onSubmit={submitTask}>
                <h5>
                  <FaFontAwesomeFlag /> General information
                </h5>
